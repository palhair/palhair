...
Я начинал свой путь с администрирования сайта на Joomla, постепенно самостоятельно изучая языки программирования. Стало интересно именно разрабатывать, поэтому решил пройти курсы. Т.к. знания уже были выбрал мидл фронтенд разработчик от яндекс практикум, с которым успешно справился. На курсах впервые удалось поработать в команде (5 человек).
Ищу работу чтобы продолжить работать в команде.
